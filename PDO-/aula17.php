    ...
    <!-- Button trigger modal -->
        ...
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-header"> style="background-color: #ccc;"
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Modal Camilly</h1>
            ...
            <tbody>
                ...
                <td>Otto</td>
                <td>
                    <button type="button" class="btn btn-primary" style="font-size: 12px; font-weight: bold;" onclick="addServico(1,'Formatar', 150)">
